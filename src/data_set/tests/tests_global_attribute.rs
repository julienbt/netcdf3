...
fn test_add_global_attr_i8() {
    ...
    data_set
        .add_global_attr_i8(GLOBAL_ATTR_NAME, GLOBAL_ATTR_DATA.to_vec())
        .unwrap();

    assert_eq!(1, data_set.num_global_attrs());
    assert_eq!(true, data_set.has_global_attr(GLOBAL_ATTR_NAME));
    assert_eq!(
        Some(GLOBAL_ATTR_DATA_LEN),
        data_set.get_global_attr_len(GLOBAL_ATTR_NAME)
    );
    assert_eq!(
        Some(DataType::I8),
        data_set.get_global_attr_data_type(GLOBAL_ATTR_NAME)
    );

    // Then retreive the `i8` stored values
    assert_eq!(
        Some(&GLOBAL_ATTR_DATA[..]),
        data_set.get_global_attr_i8(GLOBAL_ATTR_NAME)
    );
    assert_eq!(None, data_set.get_global_attr_u8(GLOBAL_ATTR_NAME));
    assert_eq!(None, data_set.get_global_attr_i16(GLOBAL_ATTR_NAME));
...
fn test_add_global_attr_u8() {
    ...
    data_set
        .add_global_attr_u8(GLOBAL_ATTR_NAME, GLOBAL_ATTR_DATA.to_vec())
        .unwrap();
    ...
    assert_eq!(
        Some(&GLOBAL_ATTR_DATA[..]),
        data_set.get_global_attr_u8(GLOBAL_ATTR_NAME)
    );
    assert_eq!(None, data_set.get_global_attr_i16(GLOBAL_ATTR_NAME));
    assert_eq!(None, data_set.get_global_attr_i32(GLOBAL_ATTR_NAME));
    assert_eq!(None, data_set.get_global_attr_f32(GLOBAL_ATTR_NAME));
...
fn test_add_global_attr_i16() {
    ...
    data_set
        .add_global_attr_i16(GLOBAL_ATTR_NAME, GLOBAL_ATTR_DATA.to_vec())
        .unwrap();
    ...
    assert_eq!(
        Some(&GLOBAL_ATTR_DATA[..]),
        data_set.get_global_attr_i16(GLOBAL_ATTR_NAME)
    );
    assert_eq!(None, data_set.get_global_attr_i32(GLOBAL_ATTR_NAME));
    assert_eq!(None, data_set.get_global_attr_f32(GLOBAL_ATTR_NAME));
    assert_eq!(None, data_set.get_global_attr_f64(GLOBAL_ATTR_NAME));
...
fn test_add_global_attr_i32() {
    ...
    data_set
        .add_global_attr_i32(GLOBAL_ATTR_NAME, GLOBAL_ATTR_DATA.to_vec())
        .unwrap();
    ...
    assert_eq!(
        Some(&GLOBAL_ATTR_DATA[..]),
        data_set.get_global_attr_i32(GLOBAL_ATTR_NAME)
    );
    assert_eq!(None, data_set.get_global_attr_f32(GLOBAL_ATTR_NAME));
    assert_eq!(None, data_set.get_global_attr_f64(GLOBAL_ATTR_NAME));
}
...
fn test_add_global_attr_f32() {
    ...
    data_set
        .add_global_attr_f32(GLOBAL_ATTR_NAME, GLOBAL_ATTR_DATA.to_vec())
        .unwrap();
    ...
    assert_eq!(
        Some(&GLOBAL_ATTR_DATA[..]),
        data_set.get_global_attr_f32(GLOBAL_ATTR_NAME)
    );
    assert_eq!(None, data_set.get_global_attr_f64(GLOBAL_ATTR_NAME));
}
...
fn test_add_global_attr_f64() {
    ...
    data_set
        .add_global_attr_f64(GLOBAL_ATTR_NAME, GLOBAL_ATTR_DATA.to_vec())
        .unwrap();
    ...
    assert_eq!(
        Some(&GLOBAL_ATTR_DATA[..]),
        data_set.get_global_attr_f64(GLOBAL_ATTR_NAME)
    );
}
...
fn test_rename_global_attr() {
    ...
    data_set
        .add_global_attr_i8(GLOBAL_ATTR_NAME_1, GLOBAL_ATTR_DATA.to_vec())
        .unwrap();
    ...
    assert_eq!(
        Some(GLOBAL_ATTR_DATA_LEN),
        data_set.get_global_attr_len(GLOBAL_ATTR_NAME_1)
    );
    assert_eq!(
        Some(DataType::I8),
        data_set.get_global_attr_data_type(GLOBAL_ATTR_NAME_1)
    );
    assert_eq!(false, data_set.has_global_attr(GLOBAL_ATTR_NAME_2));
    assert_eq!(None, data_set.get_global_attr_len(GLOBAL_ATTR_NAME_2));
    assert_eq!(None, data_set.get_global_attr_data_type(GLOBAL_ATTR_NAME_2));
    ...
    assert_eq!(
        Some(&GLOBAL_ATTR_DATA[..]),
        data_set.get_global_attr_i8(GLOBAL_ATTR_NAME_1)
    );
    assert_eq!(None, data_set.get_global_attr_i8(GLOBAL_ATTR_NAME_2));
    ...
    assert_eq!(
        Some(GLOBAL_ATTR_DATA_LEN),
        data_set.get_global_attr_len(GLOBAL_ATTR_NAME_2)
    );
    assert_eq!(
        Some(DataType::I8),
        data_set.get_global_attr_data_type(GLOBAL_ATTR_NAME_2)
    );

    assert_eq!(None, data_set.get_global_attr_i8(GLOBAL_ATTR_NAME_1));
    assert_eq!(
        Some(&GLOBAL_ATTR_DATA[..]),
        data_set.get_global_attr_i8(GLOBAL_ATTR_NAME_2)
    );
}
...
fn test_add_global_attr_error_attr_name_not_valid() {
    ...
    assert_eq!(
        None,
        data_set.get_global_attr_data_type(INVALID_GLOBAL_ATTR_NAME)
    );
    ...
    assert_eq!(
        ...
        data_set
            .add_global_attr_i8(INVALID_GLOBAL_ATTR_NAME, GLOBAL_ATTR_DATA.to_vec())
            .unwrap_err()
    );
...
fn test_add_var_attr_error_attr_already_exists() {
    ...
    data_set
        .add_global_attr_i8(GLOBAL_ATTR_NAME, GLOBAL_ATTR_DATA_1.to_vec())
        .unwrap();

    assert_eq!(1, data_set.num_global_attrs());
    assert_eq!(true, data_set.has_global_attr(GLOBAL_ATTR_NAME));
    assert_eq!(
        Some(GLOBAL_ATTR_DATA_LEN_1),
        data_set.get_global_attr_len(GLOBAL_ATTR_NAME)
    );
    assert_eq!(
        Some(DataType::I8),
    ...
    assert_eq!(
        ...
        data_set
            .add_global_attr_i8(GLOBAL_ATTR_NAME, GLOBAL_ATTR_DATA_2.to_vec())
            .unwrap_err()
    );
...
fn test_rename_var_attr_error_attr_already_exists() {
    ...
    data_set
        .add_global_attr_i8(GLOBAL_ATTR_NAME_1, GLOBAL_ATTR_DATA_1.to_vec())
        .unwrap();
    data_set
        .add_global_attr_i8(GLOBAL_ATTR_NAME_2, GLOBAL_ATTR_DATA_2.to_vec())
        .unwrap();
    ...
    assert_eq!(
        ...
        data_set
            .add_global_attr_i8(GLOBAL_ATTR_NAME_1, GLOBAL_ATTR_DATA_2.to_vec())
            .unwrap_err()
    );
...
fn test_rename_var_attr_error_attr_not_defined() {
    ...
    assert_eq!(
        None,
        data_set.get_global_attr_data_type(UNDEF_GLOBAL_ATTR_NAME)
    );
    ...
    assert_eq!(
        ...
        data_set
            .rename_global_attr(UNDEF_GLOBAL_ATTR_NAME, GLOBAL_ATTR_NAME_2)
            .unwrap_err()
    );
...
fn test_remove_var_attr_error_attr_not_defined() {
    ...
    assert_eq!(
        InvalidDataSet::GlobalAttributeNotDefined(UNDEF_GLOBAL_ATTR_NAME.to_string()),
        data_set
            .remove_global_attr(UNDEF_GLOBAL_ATTR_NAME)
            .unwrap_err()
    );
