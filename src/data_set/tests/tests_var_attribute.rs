...
fn test_rename_var_attr() {
    ...
    assert_eq!(Some(&VAR_ATTR_DATA[..]), data_set.get_var_attr_i8(VAR_NAME, VAR_ATTR_NAME_2));
}
...
fn test_add_var_attr_error_attr_already_exists() {
    ...
    assert_eq!(Some(1), data_set.num_var_attrs(VAR_NAME));
    assert_eq!(Some(true), data_set.has_var_attr(VAR_NAME, VAR_ATTR_NAME));
    assert_eq!(Some(&VAR_ATTR_DATA_1[..]), data_set.get_var_attr_i8(VAR_NAME, VAR_ATTR_NAME));
}
...
fn test_rename_var_attr_error_attr_already_exists() {
    ...
    assert_eq!(Some(&VAR_ATTR_DATA_1[..]), data_set.get_var_attr_i8(VAR_NAME, VAR_ATTR_NAME_1));
    assert_eq!(Some(&VAR_ATTR_DATA_2[..]), data_set.get_var_attr_i8(VAR_NAME, VAR_ATTR_NAME_2));
}
