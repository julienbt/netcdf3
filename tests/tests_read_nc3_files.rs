...
use copy_to_tmp_file::{
    copy_bytes_to_tmp_file, EMPTY_DATA_SET_FILE_BYTES, EMPTY_DATA_SET_FILE_NAME, NC3_64BIT_OFFSET_FILE_BYTES, NC3_64BIT_OFFSET_FILE_NAME,
    NC3_CLASSIC_FILE_BYTES, NC3_CLASSIC_FILE_NAME, NC3_FILL_VALUES_FILE_BYTES, NC3_FILL_VALUES_FILE_NAME,
...
use netcdf3::{error::ReadError, DataSet, DataType, Dimension, DimensionType, FileReader, Variable, Version};
